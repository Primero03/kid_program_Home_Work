...
public class StudentSteam implements Iterable<StudentGroup> {
    ...
    /**
     * Конструктор класса потока студентов
     * 
     * @param listGroup - принимает список групп из студентов
    ...
    public void print(StudentSteam steam) {
        for (StudentGroup group : steam.getListGroup()) {
            System.out.println();
            System.out
                    .println("Группа номер:" + group.getIdGroup() + " Кол-во студентов в гурппе:" + group.getLength());
